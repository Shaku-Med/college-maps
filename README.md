...
- **Moving the map while navigating**: in directions and navigation the map can be turned as well as dragged and zoomed. Touching it pauses following; about 8 seconds after the map comes to rest it glides back to the walker's position and follows again, keeping the rotation they chose. A compass button appears whenever the map is turned and points it north again. Back in browsing, the map always faces north.
